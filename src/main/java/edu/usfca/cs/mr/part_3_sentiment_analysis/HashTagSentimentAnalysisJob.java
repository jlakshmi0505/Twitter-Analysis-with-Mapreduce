 ...
 */
public class HashTagSentimentAnalysisJob {
    public static void main(String[] args) {
        try {
            Configuration conf = new Configuration();

            /* Job Name. You'll see this in the YARN webapp */
            Job job = Job.getInstance(conf, "Hash Tag Sentiment Analysis Job");

            /* Current class */
            job.setJarByClass(HashTagSentimentAnalysisJob.class);
