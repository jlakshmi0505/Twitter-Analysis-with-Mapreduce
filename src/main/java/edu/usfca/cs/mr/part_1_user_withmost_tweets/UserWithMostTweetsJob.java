 ...
 */
public class UserWithMostTweetsJob {
    public static void main(String[] args) {
        try {
            Configuration conf = new Configuration();

            /* Job Name. You'll see this in the YARN webapp */
            Job job = Job.getInstance(conf, "User with most tweet job");

            /* Current class */
            job.setJarByClass(UserWithMostTweetsJob.class);

            /* Mapper class */
            job.setMapperClass(UserWithMostTweetsMapper.class);
            ...
            /* Reducer class */
            job.setReducerClass(UserWithMostTweetsReducer.class);
