 ...
 */
public class TopMentionedUserJob {
    public static void main(String[] args) {
        try {
            Configuration conf = new Configuration();

            /* Job Name. You'll see this in the YARN webapp */
            Job job = Job.getInstance(conf, "Top Mentioned User Each YearJob");

            /* Current class */
            job.setJarByClass(TopMentionedUserJob.class);

            /* Mapper class */
            job.setMapperClass(TopMentionedUserMapper.class);
            ...
            /* Reducer class */
            job.setReducerClass(TopMentionedUserReducer.class);

            /* Outputs from the Mapper. */
            job.setMapOutputKeyClass(Text.class);
            job.setMapOutputValueClass(TopUserMentionedEachYear.class);
