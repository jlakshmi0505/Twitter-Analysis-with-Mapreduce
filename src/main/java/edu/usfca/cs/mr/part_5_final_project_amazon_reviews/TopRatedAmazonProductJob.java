 ...
 */
public class TopRatedAmazonProductJob {
    public static void main(String[] args) {
        try {
            Configuration conf = new Configuration();

            /* Job Name. You'll see this in the YARN webapp */
            Job job = Job.getInstance(conf, "Top Rated Amazon Product Job");

            /* Current class */
            job.setJarByClass(TopRatedAmazonProductJob.class);

            /* Mapper class */
            job.setMapperClass(TopRatedAmazonProductMapper.class);
            ...
            /* Reducer class */
            job.setReducerClass(TopRatedAmazonProductReducer.class);
