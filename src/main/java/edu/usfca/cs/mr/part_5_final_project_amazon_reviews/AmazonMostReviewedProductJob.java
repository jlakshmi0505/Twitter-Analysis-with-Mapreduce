 ...
 */
public class AmazonMostReviewedProductJob {
    public static void main(String[] args) {
        try {
            Configuration conf = new Configuration();

            /* Job Name. You'll see this in the YARN webapp */
            Job job = Job.getInstance(conf, "Amazon Most Reviewed Product Job");

            /* Current class */
            job.setJarByClass(AmazonMostReviewedProductJob.class);

            /* Mapper class */
            job.setMapperClass(AmazonMostReviewedProductMapper.class);
            ...
            /* Reducer class */
            job.setReducerClass(AmazonMostReviewedProductReducer.class);

            /* Outputs from the Mapper. */
            job.setMapOutputKeyClass(Text.class);
            job.setMapOutputValueClass(AmazonProduct.class);

            /* Outputs from the Reducer */
            job.setOutputKeyClass(Text.class);
            job.setOutputValueClass(AmazonProduct.class);
